 ...
 * Layout Structure:
 * [
 * Foreground Layout = RelativeLayout [ContentView + AccessoryView]]
 * Background Layout = [Default Null]
 * ]
 * <p>
...
public class UITableViewCell<T extends UITableViewCellModel> extends FrameLayout {
    ...
    protected void internalAddView(View child) {
    ...
    // }
    //
    // public Drawable getUserSeparatorDrawable() {
    //     return mUserSeparatorDrawable;
    // }
    //
