...
public class UITableViewDelegate {
    ...
    // public int separatorColorAtIndexPath(UITableView tableView, UITableViewCell tableViewCell, NSIndexPath indexPath) {
    //     // Return transparent which will be ignored and the default color will be set.
